...
class _PinCodeTextFieldState extends State<PinCodeTextField> with TickerProviderStateMixin {
  ...
  Color _getColorFromIndex(int index) {
    var _inputString = _inputList.isEmpty ? _inputList[_selectedIndex - 1] : '';
    if (!widget.enabled) {
    ...
    } else if (_selectedIndex > index && (_inputString.isEmpty)) {
            ...
            child: AutofillGroup(
              child: TextFormField(
                ...
                style: TextStyle(
                  ...
                  height: .01,
                  fontSize:
                      kIsWeb ? 1 : 0.01, // it is a hidden textfield which should remain transparent and extremely small
                ),
              ),
            ),
          ),
